...
// FIXME: vercelへデプロイ時に、getStaticProps関数内で Prerendering Error 発生
...
// }
 ...
 // NOTE: デプロイするためのダミーのデータ(本来はSSGで取得すべき)
const dummyData = [
...
const Home: NextPage<{ initPrefList: Prefecture[] }> = ({ initPrefList }) => {
  const [prefList, setPrefList] = useState<Prefecture[]>(dummyData)
